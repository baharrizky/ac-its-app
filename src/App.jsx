...
const PRACTICE_POOL = {
  ...
  E14: [
    ...
    { text: "$\\log_5(x-2)\\ge1$, maka...", options: [{text:"x\\ge7",correct:true},{text:"x>2 saja",tag:"Hanya menggunakan domain"},{text:"x\\le3",tag:"Membalik arah padahal basis >1"},{text:"x\\ge2",tag:"Batas numerus harus menghasilkan ≥5"},{text:"x>5",tag:"Salah mengubah bentuk"}] },
