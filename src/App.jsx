...
const PRACTICE_POOL = {
  ...
  E14: [
    ...
    { text: "$\\log_5(x-2)\\ge1$, maka...", options: [{text:"x\\ge7",correct:true},{text:"x>2 saja",tag:"Hanya menggunakan syarat domain, lupa menyelesaikan pertidaksamaannya"},{text:"x\\le7",tag:"Membalik arah padahal basis >1"},{text:"x\\ge3",tag:"Lupa mengubah 1 menjadi 5^1=5, hanya menambahkan 2 ke ruas kanan"},{text:"x>5",tag:"Salah mengubah bentuk pertidaksamaan logaritma"}] },
